...
SCRIPT_PATH="$PROJECT_DIR/.dendrita/archived/scripts/run-identify.sh"
...
<dict>
    ...
    <string>${PROJECT_DIR}/.dendrita/archived/logs/identify.log</string>
    <key>StandardErrorPath</key>
    <string>${PROJECT_DIR}/.dendrita/archived/logs/identify-error.log</string>
...
EOF
    ...
    mkdir -p "${PROJECT_DIR}/.dendrita/archived/logs"
    ...
    echo -e "   Logs: ${PROJECT_DIR}/.dendrita/archived/logs/"
    ...
    CRON_ENTRY="0 2 * * * /bin/bash ${SCRIPT_PATH} >> ${PROJECT_DIR}/.dendrita/archived/logs/identify.log 2>&1"
    ...
    if crontab -l 2>/dev/null | grep -q "${SCRIPT_PATH}"; then
        ...
        echo -e "${GREEN}✅ Configurado para ejecutarse diariamente a las 2:00 AM${NC}"
        echo -e "   Logs: ${PROJECT_DIR}/.dendrita/archived/logs/identify.log"

 ...
 * 
 * Uso:
 *   ts-node .dendrita/integrations/scripts/google-workspace/list-drive-folders.ts <folder-name> [page-size]
 * 
 * Ejemplos:
 *   ts-node .dendrita/integrations/scripts/google-workspace/list-drive-folders.ts [folder-name]
 *   ts-node .dendrita/integrations/scripts/google-workspace/list-drive-folders.ts [folder-name] 50
 */

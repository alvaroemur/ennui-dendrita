...
- ✅ No existe `.dendrita/users/` o está vacío
- ✅ No hay archivos de usuario en `.dendrita/users/`
- ✅ El usuario indica explícitamente que es un repositorio nuevo

**Condición de activación:**

```markdown
SI (no existe .dendrita/users/) O (existe pero está vacío) O (usuario indica "nuevo repositorio")
...
### 1. `.dendrita/users/[user-id]/profile.json`
...
### 2. `.dendrita/users/[user-id]/workspace-defaults.json`
...
### 3. `.dendrita/users/[user-id]/profiles/workspace-[workspace].json` (si se crea)
...
- Carpeta .dendrita/users/ no existe

Solución: Verificar permisos y crear .dendrita/users/ si no existe.
```
...
- `.dendrita/users/README.md` - Documentación completa del sistema de usuarios
- `.dendrita/settings.json` - Configuración general del sistema
- `.dendrita/hooks/README.md` - Documentación general de hooks

---
name: dendrita-connections
description: "Dendrita Connections Hook"
type: hook
created:
...
- ✅ El usuario dice "dendrita conexiones", "dendrita connections", "muéstrame las conexiones" o "show me connections"
- ✅ El usuario pregunta "qué proyectos están relacionados" o "what projects are related"
- ✅ El usuario solicita "red de stakeholders", "stakeholder network", "mapa de conexiones" o "connection map"
- ✅ El usuario menciona "dependencias", "dependencies", "relaciones entre componentes" o "relationships between components"
- ✅ El usuario pregunta "cómo se conecta X con Y" o "how does X connect with Y"

**Patrones de activación (bilingües):**

```markdown
- "dendrita conexiones" / "dendrita connections"
- "muéstrame las conexiones" / "show me connections"
- "qué proyectos están relacionados" / "what projects are related"
- "red de stakeholders" / "stakeholder network"
- "mapa de conexiones" / "connection map"
- "dependencias" / "dependencies"
- "relaciones entre componentes" / "relationships between components"
- "cómo se conecta [X] con [Y]" / "how does [X] connect with [Y]"
```
...
**For more information:** See `.dendrita/hooks/dendrita-openup.md` for hidden insights revelation, and `.dendrita/hooks/list-system-components.md` for components listing.

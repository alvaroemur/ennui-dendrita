...
2. **Source Prioritization**: You will search across:
   ...
   - ESG and sustainability forums (for ennui-dendrita context)
...
**For ennui-dendrita Context:**
When researching sustainability, ESG, or social impact topics:
- Search for best practices in corporate sustainability
- Find case studies of similar initiatives
- Research MEL (Monitoring, Evaluation, Learning) systems
- Look for fundraising strategies and donor trends
- Find governance models for multi-stakeholder projects

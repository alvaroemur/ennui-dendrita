 ...
 * la lógica de activación de skills y aplicar el comportamiento documentado
 * reflexivamente.
 * 
 * Comportamiento esperado:
 * 1. Al recibir un prompt del usuario, revisar .dentrita/skills/skill-rules.json
 * 2. Comparar el prompt contra keywords e intentPatterns
 * 3. Identificar skills relevantes basados en matches
 * 4. Leer el archivo SKILL.md correspondiente en .dentrita/skills/[skill-name]/SKILL.md

...
Los hooks en `.dentrita/hooks/` son **referencias de comportamiento**, NO scripts ejecutables. Cursor debe LEER estos archivos para entender el comportamiento esperado, pero NO se ejecutan.
...
**Para más información:** Ver `.dentrita/hooks/README.md` y `.cursorrules` en la raíz del proyecto.
